...
static const struct hid_device_id hid_have_special_driver[] = {
	...
	{ HID_USB_DEVICE(USB_VENDOR_ID_RFTOUCHPANL, USB_DEVICE_ID_RFTOUCHPANL_5D1) },
	...
	{ HID_USB_DEVICE(USB_VENDOR_ID_COOLTOUCH, USB_DEVICE_ID_COOLTOUCH_2306) },
